...
$sql = 'SELECT m.user, m.picture, p.* FROM members m, posts p WHERE m.id=p.member_id LIMIT :start, :list ORDER BY date DESC, author ASC';
...
<div id="wrap">
  ...
  <div id="content">
    ...
    <form action="" method="post">
      <dl>
        <?php  ?>
        <dt><?php echo $members; ?>さん、メッセージをどうぞ</dt>
        <dd>
